    ...
    <html>
        ...
        <header className="absolute inset-x-0 top-0 z-50">
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            {/* Centering the links */}
            <div className="hidden md:flex md:gap-x-12 md:justify-center md:flex-1">
              ...
              <Link href="/team" className="text-sm font-semibold leading-6 text-gray-900">Team</Link>
              <Link href="/contact" className="text-sm font-semibold leading-6 text-gray-900">Contact</Link>
            </div>

      <div className="lg:flex lg:flex-1 lg:justify-end hidden md:block">
